...
Every prompt used in the paper, as printed in Appendix D.
...
| `student_system_stage2.txt` | Stage-2 training and all pool / held-out inference of the released model | frequency line `<keep> 27%, <edit> 19%, <delete> 25%, <rewrite> 30%`; the two files differ only in that line |
