# Vendored from the ProX repository (chunk-level refining program executor), unchanged apart from this header.
# Used by the ProX-C baseline runners (baselines/prox_c/, evaluation/heldout_pipeline/).
def split_doc(text):
    """
