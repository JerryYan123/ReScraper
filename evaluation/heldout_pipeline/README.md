...
| D | `stages/s1_ours_exec.py`, `stages/s3_gather.py` | execute the student programs (`lib/ours_exec.py`), teacher fidelity (`evaluation/fidelity/teacher_metrics.py`), collect every text to score | `lib/rescraper_ops.py` executor | CPU, 2-3 min |
